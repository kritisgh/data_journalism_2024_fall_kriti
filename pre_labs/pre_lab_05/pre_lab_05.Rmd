...
**Task** Load the five CSV files. Do they have the same column structure? **Answer** Yes, they all have 25 rows and 8 columns. 
...
**Task** Run the following code to join Maryland population data and the 2020 voter registration data together using the common column county as the key. How many rows are there now? How many *should* there be? **Answer** 24 rows. There should be 24 rows because it got rid of the TOTAL column.
...
**Task** Create a new dataframe with population and voter data joined together. What does the output message below say about the join? **Answer** I believe the ouput message means it is joining by COUNTY because we did not explicitly mention what to join by. 
...
**Task** Using mutate, let's find the county with the highest 18+ Black population as a percentage of all population 18 and over and also the percentage of Democrats in that county. Put your answers below. **Answer** Prince George's has the highest 18+ black population as well as the highest democrat population. 
...
**Task** Now let's find the county with the highest 18+ Asian population as a percentage of all population 18 and over and also the percentage of Democrats in that county. How do these results compare to the previous task? Put your answers below. **Answer** Howard county has the highest asian 18+ population with 52% democrats. Prince George's moved 5 ranks below here. 
