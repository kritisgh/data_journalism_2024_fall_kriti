...
**Answer** Yes, it mostly makes sense. Did pretty well for the first 10 results. All of them are some kind of merchandise except for one called "maga poll" 

```{r}

emails_subset <- emails |> 
  slice_head(n = 10)
