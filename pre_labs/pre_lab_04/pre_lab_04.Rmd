...
**Task** Run the following code to group and count records in the recipient_name column, and filter to examine only recipients that start with W. Name a problem that you see that is preventing proper grouping. **Answer** Multiple versions of spelling and case of the same restaurant is preventing proper grouping. 
...
**Task** Run the following code to group by recipient_clean and recipient_name, then filter for cities that start with W. Name three changes the refinr function made in the first 20 results. **Answer** We went from 6 variations down to 2 with W. Millar & Co. W. MILLAR & CO, W. MILLAR & CO., and W. Millar & Co. were all changed to W. MILLAR & CO. and W Millar Catering, W. MILLAR & CO. CATERING and W.Millar & Company Catering were changed to W. MILLAR & CO. CATERING. Walgreens was changed to WALGREENS -- a change in the case. Walmart was changed to WALMART -- change in case. Hilton Washington and HILTON WASHINGTON was changed to WASHINGTON HILTON. This results in lesser categories. 
...
**Task** Run the following code to use the n_gram_merge() function to clean the data, then group by city_clean and city to examine cities that start with A. Look at the differences. Does the changes it made vary substantially from the previous use of key_collision_merge? **Answer** Nope, I don't see any difference in the first 20 rows compared to the previous output. 
