...
md_hogan_map <- md_counties |>
  st_join(md_hogan_performance_2018_and_2024, join = st_intersects, left = TRUE)
...
#md_hogan_map <- md_counties |> left_join(hogan_2018_v_2024, join_by("GEOID"))
#md_hogan_map <- md_counties |>
  #left_join(hogan_2018_v_2024, by = c("GEOID"))
```
...
md_pres_with_abortion <- md_pres_county_24 |> left_join(md_abortion_24, by=c("NAME"="County"))
