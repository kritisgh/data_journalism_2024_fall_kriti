---
title: "Reverse Engineering Project - Congress Older"
author: "Kriti Singh, Leonardo Micheli, Molecule Jongwilai, Adelia McGuire"
date: "9/28/2024"
output:
  html_document:
    theme: cerulean
...
* **Analysis summary**: [Forty-eight percent of the current Congress is made up of boomers, even though they only represented about 21 percent of the population in the most recent census. And this actually represents a decline in representation for boomers, who made up 63 percent of Congress in the mid-2010s]
...
congress_age |>
  ...
  filter(generation == "Boomers") |>
  summarise(
    count_114_boomers = n() #340
  )
(340/541)*100 # 62.84658%
# Display results of code below this codeblock
...
* **Sentence text**: [Thanks to their size, baby boomers have been an especially long-lasting force in congressional politics. *Boomers are now in their 25th consecutive Congress,4 but still make up about half the membership,* putting them well ahead of earlier generations. *In its 25th Congress, the Silent Generation only made up about one-third of Congress,* *while the earlier Lost Generation made up only around a quarter at the same point.*]
...
```{r}
# Put code to reverse engineer sentence here
#Median age of Boomers in 2001 Congress.
congress_age |>
...
#Median age of Silent Generation in 1979 Congress.
congress_age |>
...
#Median age of 118th Congress's senators.
congress_age |>
  filter(congress == "118") |>
...
#Median age of 118th Congress's representatives.
congress_age |>
  filter(congress == "118") |>
...
#Median age of representatives in three previous Congress.
congress_age |>
...
#Median age of senators from each Congress that were in 1919 - 1999. 
congress_age |>
...
#Median age of representatives from each Congress that were in 1919 - 1999. 
congress_age |>
  filter(start_date <= "1999-01-03") |>
  filter(chamber == "House") |>
  group_by(congress) |>
...
#The median age of senators from each Congress that was in 1919 to 1999 ranged from 51.68 to 59.91.
#The median age of representatives from each Congress that was in 1919 to 1999 ranged from 48.36 to 54.51.
```
-30-